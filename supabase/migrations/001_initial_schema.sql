...
-- Insert seed data
INSERT INTO horses (name, owner, patient_id) VALUES
('DUTCHESS OF HAZELBANK', 'FREEDOM FARM/HAZELBANK INC', 'DUTCHESS'),
('AMBUSHKA', 'FREEDOM FARM', 'AMBUSHKA');
...
((SELECT id FROM horses WHERE name = 'DUTCHESS OF HAZELBANK'), 'FR', 'Lateral', 'DX', 'Right Fore Foot Lateral', '2026-01-26', 'https://placeholder-for-xray.jpg'),
((SELECT id FROM horses WHERE name = 'DUTCHESS OF HAZELBANK'), 'FR', 'Lateral', 'DX', 'Right Fore Foot Lateral', '2026-06-22', 'https://placeholder-for-xray.jpg');
